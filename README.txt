...
a persistence unit "pfh-project6-data-serverPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "pfh-project6-data-server\pom.xml":
...
artifact ("pfh-project6-data-server.war") is already built. You can build
